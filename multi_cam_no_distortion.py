...
class RTSPServer:
    def __init__(self):
        ...
        # Set the service port for the RTSP server. Using 8554 to avoid "Address already in use" error.
        ...
        # Adjusted width to 2028x1520 to maintain aspect ratio when height is 720, to avoid distortion.
        pipeline_cam0 = (
            f'libcamerasrc camera-name={cam0_name} ! '
            'videoconvert ! '
            'video/x-raw,format=I420 ! ' # Specify I420 format
            'videoscale ! '
            'video/x-raw,width=1280,height=720,framerate=20/1 ! ' # Adjusted width for no distortion
            'videoflip method=rotate-180 ! ' # Apply 180-degree rotation (horizontal and vertical flip)
        ...
        # Adjusted width to 961 to maintain aspect ratio when height is 720, to avoid distortion.
        pipeline_cam1 = (
