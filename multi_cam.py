    ...
    def do_create_element(self, url):
        ...
        try:
            ...
            if pipeline:
                ...
                # You can add a probe here to check pipeline state changes,
                # but for initial debugging, the console output from GST_DEBUG is more effective.
            else:
...
class RTSPServer:
    def __init__(self):
        ...
        # Set the service port for the RTSP server. Common RTSP port is 8554.
        ...
        # Reverted to a caps structure closer to your original working example,
        # with format specified before videoscale, and resolution/framerate after.
        pipeline_cam0 = (
        ...
        # Same pipeline adjustment as for cam0
        pipeline_cam1 = (
